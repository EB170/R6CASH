...
CREATE TABLE IF NOT EXISTS public.transactions (
  ...
  game_id BIGINT REFERENCES public.games(id) ON DELETE SET NULL, -- Fixed: Use BIGINT instead of UUID
...
-- Update the deposit_credit function to use the new transactions table and correct Stripe fee handling
